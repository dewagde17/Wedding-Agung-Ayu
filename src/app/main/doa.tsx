...
/>
      ...
      {/* Konten Tengah */}
      <div className="relative z-10 max-w-5xl text-center pt-20 px-8 md:px-12">
        <h1 className="text-5xl sm:text-7xl tangerine-bold text-[#5f3c2d] mb-4">
          Om Swastyastu
        </h1>
        <p className="text-sm md:text-xl text-[#5f3c2d] leading-relaxed font-lora">
